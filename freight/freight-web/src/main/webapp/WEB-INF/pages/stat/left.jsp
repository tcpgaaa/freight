...
<div id="sidebar" class="sidebar">
    ...
    <div class="panel">
        ...
        <div class="panel-content">
			<ul>
				<li><a href="${ctx}/statChart/factorySale" onclick="linkHighlighted(this)" target="main" id="aa_1">生产厂家销售情况</a></li>
				<li><a href="${ctx}/statChart/productSale" onclick="linkHighlighted(this)" target="main" id="aa_1">产品销售排行</a></li>
				<li><a href="${ctx}/statChart/onlineInfo" onclick="linkHighlighted(this)" target="main" id="aa_1">系统访问压力图</a></li>
			</ul>
        </div>
    </div>
    </div>
